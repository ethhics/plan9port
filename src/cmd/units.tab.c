...
#line	2	"/usr/local/plan9/src/cmd/units.y"
#include <u.h>
#include <libc.h>
#include <bio.h>
...
#line	82	"/usr/local/plan9/src/cmd/units.y"
typedef union 
{
	Node	node;
	Var*	var;
...
#line	220	"/usr/local/plan9/src/cmd/units.y"
...
case 1:
#line	98	"/usr/local/plan9/src/cmd/units.y"
{
		int f;
...
case 2:
#line	111	"/usr/local/plan9/src/cmd/units.y"
{
		int f, i;
...
case 3:
#line	134	"/usr/local/plan9/src/cmd/units.y"
{
		retnode1 = yypt[-0].yyv.node;
	} break;
case 4:
#line	138	"/usr/local/plan9/src/cmd/units.y"
{
		retnode1 = one;
	} break;
case 6:
#line	145	"/usr/local/plan9/src/cmd/units.y"
{
		add(&yyval.node, &yypt[-2].yyv.node, &yypt[-0].yyv.node);
	} break;
case 7:
#line	149	"/usr/local/plan9/src/cmd/units.y"
{
		sub(&yyval.node, &yypt[-2].yyv.node, &yypt[-0].yyv.node);
	} break;
case 9:
#line	156	"/usr/local/plan9/src/cmd/units.y"
{
		mul(&yyval.node, &yypt[-2].yyv.node, &yypt[-0].yyv.node);
	} break;
case 10:
#line	160	"/usr/local/plan9/src/cmd/units.y"
{
		div(&yyval.node, &yypt[-2].yyv.node, &yypt[-0].yyv.node);
	} break;
case 12:
#line	167	"/usr/local/plan9/src/cmd/units.y"
{
		mul(&yyval.node, &yypt[-1].yyv.node, &yypt[-0].yyv.node);
	} break;
case 14:
#line	174	"/usr/local/plan9/src/cmd/units.y"
{
		xpn(&yyval.node, &yypt[-1].yyv.node, yypt[-0].yyv.numb);
	} break;
case 15:
#line	178	"/usr/local/plan9/src/cmd/units.y"
{
		int i;
...
case 17:
#line	198	"/usr/local/plan9/src/cmd/units.y"
{
		div(&yyval.node, &yypt[-2].yyv.node, &yypt[-0].yyv.node);
	} break;
case 18:
#line	204	"/usr/local/plan9/src/cmd/units.y"
{
...
case 19:
#line	212	"/usr/local/plan9/src/cmd/units.y"
{
		yyval.node = one;
		yyval.node.val = yypt[-0].yyv.val;
	} break;
case 20:
#line	217	"/usr/local/plan9/src/cmd/units.y"
{
